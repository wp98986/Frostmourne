export default {
  ...
  'validation.logo.required': '请选择图标',
  'validation.code.required': '请输入编码',
  'validation.name.required': '请输入名称',
  'validation.sortCode.required': '请输入排序号',
  'validation.desc.required': '请输入介绍',
  'validation.site.required': '请选择端口',
  'validation.functions.required': '请选择功能模块',
  'validation.enableFlag.required': '请选择是否有效',
  'validation.isDefault.required': '请输入是否默认',
  'validation.app.required': '请选择应用',
  'form.captcha': '获取验证码',
  ...
  'component.globalHeader.orderMessage': '消息',
  ...
  // ECRP
  'menu.home.analysis': '监控台',
  // SITE
  'menu.homepage': '首页',
  'menu.homepage.homepageview': '首页',

  'menu.user': '用户',
  'menu.user.login': '登录',
  'menu.user.register': '注册',
  'menu.user.modpwd': '修改密码',
  'menu.site': '基础',
  'menu.site.org': '企业信息',
  'menu.site.org.info': '企业信息',
  'menu.site.org.pwd': '交易密码',

  'menu.site.org.invitedorg': '邀请的企业',
  'menu.site.settings': '个人设置',

  'menu.site.settings.personal': '个人信息',
  'menu.site.settings.invitedorg2': '受邀企业',
  'menu.site.role': '角色信息',
  'menu.appshop': '应用',
  'menu.manage': '客户管理',

  'menu.account': '账户',
  'menu.account.modpwd': '修改密码',
  'menu.account.logout': '退出登录',

  // BOSS
  'menu.boss': '平台',

  'menu.boss.function': '功能管理',
  'menu.boss.app': '应用管理',
  'menu.boss.app.list': '应用列表',
  'menu.boss.app.view': '应用详情',
  'menu.boss.app.edit': '应用编辑',
  'menu.boss.role': '角色管理',
  'menu.boss.role.list': '角色列表',
  'menu.boss.role.view': '角色详情',
  'menu.boss.role.edit': '角色编辑',
  'menu.boss.function.list': '功能列表',
  'menu.boss.function.view': '功能详情',
  'menu.boss.function.edit': '功能编辑',
  'menu.boss.propertybag': '属性包管理',
  'menu.boss.propertybag.list': '属性包管理列表',
  'menu.boss.propertybag.add': '属性包管理新增',
  'menu.boss.propertybag.edit': '属性包管理编辑',
  'menu.boss.propertybag.view': '属性包管理查看',

  'menu.notification': '消息',
  'menu.notification.mynotice': '我的消息',
  'menu.notification.mynotice.list': '消息列表',

  'menu.notice': '通知管理',
  'menu.notice.noticemanage': '通知',
  'menu.notice.noticemanage.list': '通知列表',
  'menu.notice.noticemanage.add': '新增通知',
  'menu.notice.noticemanage.edit': '编辑通知',
  ...
  'app.settings.menuMap.basic': '企业信息',
  'app.settings.menuMap.department': '部门信息',
  'app.settings.menuMap.security': '安全设置',
  'app.settings.menuMap.personal': '个人信息',
  'app.settings.menuMap.binding': '账号绑定',
  'app.settings.menuMap.notification': '新消息通知',
  'app.settings.basic.avatar': '头像',
  'app.settings.basic.change-avatar': '更换头像',
  'app.settings.basic.change-pic': '更换图标',
  'app.settings.basic.email': '邮箱',
  'app.settings.basic.name': '用户名',
  'app.settings.basic.sex': '性别',
  'app.settings.basic.sex-message': '请选择您的性别',
  'app.settings.basic.name-message': '昵称不能为空',
  'app.settings.basic.realName': '真实姓名',
  'app.settings.basic.realName-message': '请填写您的真实姓名',
  'app.settings.basic.idCard': '身份证号码',
  'app.settings.basic.idCard-message': '请填写您的身份证号码',
  ...
  'app.settings.basic.address': '详细地址',
  'app.settings.basic.address-message': '请输入您的详细地址',
  'app.settings.basic.phone': '手机号码',
  'app.settings.basic.phone-message': '请输入您的手机号码',
  'app.settings.basic.update': '更新基本信息',
  'app.settings.basic.save': '保存',
