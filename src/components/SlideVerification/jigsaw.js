...
let l = 30, // 滑块边长
  ...
  h = document.body.clientWidth * 0.35, // canvas高度
  PI = Math.PI;
let L = l + r * 2 + 3; // 滑块实际边长
...
class jigsaw {
  constructor({ el, width, onSuccess, onFail, onRefresh }) {
    changeSize(width);
  ...
  initDOM() {
    ...
    const slider = createElement('div', 'sliderBtn');
