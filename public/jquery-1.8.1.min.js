    ...
    (function(a, b) {
      ...
      function bf(a, b, c) {
        ...
        for (; (d = a[g]); g++)
          f.relative[d.part]
            ...
            : (e = be(e, f.filter[d.part].apply(null, d.captures.concat(b, c))));
        return e;
      }
      function bg(a) {
        return function(b) {
      ...
      var c,
        ...
        Y = T(function(a) {
          ...
          var b =
            q.getElementsByName &&
            q.getElementsByName(o).length === 2 + q.getElementsByName(o + 0).length;
            ...
            T(function(a) {
              (a.innerHTML = "<select><option selected=''></option></select>"),
                a.querySelectorAll('[selected]').length ||
                  e.push(
                    '\\[' + A + '*(?:checked|disabled|ismap|multiple|readonly|selected|value)'
                  ),
